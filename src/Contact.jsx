...
const Contact = ()=>{
    ...
    const submit = (e)=>{
        e.preventDefault();
        alert(`Your name is ${data.fullname} , Your email Id is ${data.email} , Your phone number is ${data.phone} , You typed ${data.msg}`);
    }
    return (
        <>
        <div className="my-5">
                ...
                <div className="row">
                    <div className="col-md-6 col-md-6 col-10 mx-auto">
                        <form onSubmit={submit}>
                            ...
                            <input type="number" className="form-control" id="exampleFormControlInput1" placeholder="Enter your phone number" name="phone" value={data.phone} onChange={InputEvent} />
                            </div>
                            <div className="mb-3">
